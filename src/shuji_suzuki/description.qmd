...
You can find the code on github [here](https://github.com/shu65/open-problems-multimodal).
...
## Development setup
Initialise resources dir

```bash
res_dir=src/shuji_suzuki/resources
echo resources > src/shuji_suzuki/.gitignore
mkdir -p "$res_dir"
```

Download hgnc tsv file
```bash
...
git clone https://github.com/shu65/open-problems-multimodal.git "$res_dir/shu65_openproblems"
```
